        ...
        <div id="content"> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-6 col-xs-6" style="background-color:#cccccc;">
                    <div id="my-tab-content" class="tab-content">
                        <div class="tab-pane active" id="t1">
                            ...
                            <p><img src="images/Robin.gif" /> Hi there, I'm Kris!</p>
                            <p>
                        ...
                        <div class="tab-pane" id="t2">
                            ...
                            <p>
                                <b>.portfolio</b> was created for WiCS Hacks, the first women-only Hack-a-thon hosted by Women in Computer Science at UT Austin.
                                This is a responsive web-page made with Bootstrap. 
                            </p>
                            <p>
            ...
            <div class="row hidden-sm hidden-xs">
                <div class="col-lg-12 col-md-12">
                    <!-- Textbok for large screens only -->
                    Put in a Javascript Image Viewer or something

                </div>
            </div>

            <div class="row">
                <div class="col-lg-12 col-md-12" style="background-color:#cccccc;height:60px;text-align:center;color:#aaaaaa;font-family:'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-style:italic;padding-top:38px;">
